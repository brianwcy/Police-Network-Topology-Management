function [Throughput,Power,Loads,droprate,death] = func_advance_AODV_performance(Radius,nodes_link,A,PACK,nodes_number,Times,X,Y,Channel_Sel,POWERS,POWERS2,SNRs,Fload,PLest,BREAK);
...
%free 
if Channel_Sel == 1
   save data_save\r2_1.mat Throughput Power Loads droprate death
end
%two-ray
if Channel_Sel == 2
   save data_save\r2_2.mat Throughput Power Loads droprate death
end
